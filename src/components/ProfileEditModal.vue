            ...
            <div class="relative inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg w-full">
                <div class="border-b border-gray-100 m-3 items-center flex justify-between">
                    ...
                    <div class="text-right mr-2">
                        <button class="bg-primary hover:bg-light text-white text-sm font-bold px-4 py-2 rounded-full">
                            저장
                        </button>
                    </div>
                </div>
                ...
                <div class="h-80">
                    ...
                    <div class="flex flex-none items-center justify-center relative bg-gray-300 h-40">
                        <img ref="backgroundImage" src="background.png" class="object-cover absolute w-full h-full">
                        ...
                        <!-- profile image -->
                        <img ref="profileImage" src="/profile.jpeg" class="border-4 border-white w-28 h-28 rounded-full absolute -bottom-14 left-2 object-cover">
