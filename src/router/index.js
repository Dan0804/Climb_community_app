...
const routes = [
    { path: '/home', name: 'home', component: Home, title: '홈', icon: 'fa-solid fa-house-chimney fa-fw text-2xl lg:mr-2', meta: { isMenu: false, layout: 'AfterLogin', requireAuth: true} },
    { path: '/', name: 'search', component: Search, title: '검색', icon: 'fa-solid fa-magnifying-glass text-2xl lg:mr-2', meta: { isMenu: true, layout: 'AfterLogin', requireAuth: true} },
